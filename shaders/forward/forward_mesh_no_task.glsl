...
// ── Mesh workgroup 映射：每个 workgroup 对应 (drawIndex, triOffset) ──
struct MeshGroup { uint drawIndex; uint triOffset; };
layout(scalar, set=0, binding=1) readonly buffer GroupBuf { MeshGroup groups[]; } gGroups;
