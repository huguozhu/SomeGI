...
void VxgiVoxelizePass::bindScene(const SceneGpu& gpu,uint32_t tc,const VxgiResources& vxgi){ auto& vkD=static_cast<rhi::VkRHIDevice&>(*m_rhiDevice);
    ...
    w[0]={0,rhi::DescriptorType::StorageBuffer,nullptr,gpu.rhiVertexBuffer()}; w[1]={1,rhi::DescriptorType::StorageBuffer,nullptr,gpu.rhiIndexBuffer()}; w[2]={2,rhi::DescriptorType::StorageBuffer,nullptr,gpu.rhiMaterialBuffer()}; w[3]={3,rhi::DescriptorType::Sampler,nullptr,nullptr,0,0,vxSampler.get()}; w[4]={4,rhi::DescriptorType::SampledImage,nullptr,nullptr,0,0,nullptr,nullptr,m_maxTextures,m_texViewPtrs.data()}; w[5]={5,rhi::DescriptorType::StorageImage,vox};
    m_set->write({w,w+6});
}
