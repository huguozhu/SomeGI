...
void SdfgiPass::bindResources(const SdfgiResources& sf,const VxgiResources& vx,const RenderTargets& rt,VkBuffer fb){ auto& vkD=static_cast<rhi::VkRHIDevice&>(*m_rhiDevice);
    auto vox=vx.rhiView(); auto aniso=vx.anisoRhiView();
    ...
    auto sa=sf.seedARhiView(); auto sb=sf.seedBRhiView();
    auto udf=sf.udfRhiView();
    m_seedSet->write({{0,rhi::DescriptorType::SampledImage,vox},{1,rhi::DescriptorType::StorageImage,sa}});
    m_jfaAB->write({{0,rhi::DescriptorType::SampledImage,sa},{1,rhi::DescriptorType::StorageImage,sb}});
    m_jfaBA->write({{0,rhi::DescriptorType::SampledImage,sb},{1,rhi::DescriptorType::StorageImage,sa}});
    m_finA->write({{0,rhi::DescriptorType::SampledImage,sa},{1,rhi::DescriptorType::StorageImage,udf}}); m_finB->write({{0,rhi::DescriptorType::SampledImage,sb},{1,rhi::DescriptorType::StorageImage,udf}});
    m_traceSet->write({{0,rhi::DescriptorType::UniformBuffer,nullptr,ubo.get()},{1,rhi::DescriptorType::SampledImage,nr},{2,rhi::DescriptorType::SampledImage,dp},{3,rhi::DescriptorType::SampledImage,vox},{4,rhi::DescriptorType::SampledImage,aniso},{5,rhi::DescriptorType::Sampler,nullptr,nullptr,0,0,m_linearClamp.get()},{6,rhi::DescriptorType::StorageImage,out}});
}
