...
void RestirPass::bindResources(const RestirResources& res,const VxgiResources& vxgi,const RenderTargets& rt,VkBuffer ubo){ auto& vkD=static_cast<rhi::VkRHIDevice&>(*m_rhiDevice);
    ...
    auto out=rt.rhiRestirView(); auto vox=rhi::VkRHITextureView::createNonOwning(vkD,vxgi.fullView());
    const rhi::RHISampler* sp=m_linearClamp.get();
    m_initSet->write({{0,rhi::DescriptorType::UniformBuffer,nullptr,ub.get()},{1,rhi::DescriptorType::SampledImage,ab},{2,rhi::DescriptorType::SampledImage,nr},{3,rhi::DescriptorType::SampledImage,dp},{4,rhi::DescriptorType::StorageBuffer,nullptr,lb.get()},{5,rhi::DescriptorType::StorageImage,ra.get()}});
    m_spatialSet->write({{0,rhi::DescriptorType::UniformBuffer,nullptr,ub.get()},{1,rhi::DescriptorType::SampledImage,ab},{2,rhi::DescriptorType::SampledImage,nr},{3,rhi::DescriptorType::SampledImage,dp},{4,rhi::DescriptorType::StorageBuffer,nullptr,lb.get()},{5,rhi::DescriptorType::SampledImage,ra.get()},{6,rhi::DescriptorType::StorageImage,rb.get()}});
    m_shadeSet->write({{0,rhi::DescriptorType::UniformBuffer,nullptr,ub.get()},{1,rhi::DescriptorType::SampledImage,ab},{2,rhi::DescriptorType::SampledImage,nr},{3,rhi::DescriptorType::SampledImage,dp},{4,rhi::DescriptorType::StorageBuffer,nullptr,lb.get()},{5,rhi::DescriptorType::SampledImage,rb.get()},{6,rhi::DescriptorType::SampledImage,vox.get()},{7,rhi::DescriptorType::Sampler,nullptr,nullptr,0,0,sp},{8,rhi::DescriptorType::StorageImage,out}});
}
void RestirPass::bindResourcesRt(const RestirResources& res,const RenderTargets& rt,VkBuffer ubo,const rhi::RHIAccelerationStructure& tlas){ if(!m_rtShadeReady)return; auto& vkD=static_cast<rhi::VkRHIDevice&>(*m_rhiDevice);
    auto ab=rt.rhiGAlbedoMetalView(); auto nr=rt.rhiGNormalRoughView(); auto dp=rt.rhiDepthView();
    auto ub=rhi::VkRHIBuffer::createNonOwning(vkD,ubo,VK_WHOLE_SIZE); auto lb=rhi::VkRHIBuffer::createNonOwning(vkD,res.lightBuffer(),VK_WHOLE_SIZE);
    auto rb=rhi::VkRHITextureView::createNonOwning(vkD,res.reservoirB().view()); auto out=rt.rhiRestirView();
    const rhi::RHISampler* sp=m_linearClamp.get();
    m_shadeRtSet->write({{0,rhi::DescriptorType::UniformBuffer,nullptr,ub.get()},{1,rhi::DescriptorType::SampledImage,ab},{2,rhi::DescriptorType::SampledImage,nr},{3,rhi::DescriptorType::SampledImage,dp},{4,rhi::DescriptorType::StorageBuffer,nullptr,lb.get()},{5,rhi::DescriptorType::SampledImage,rb.get()},{6,rhi::DescriptorType::AccelerationStructure,nullptr,nullptr,0,0,nullptr,&tlas},{7,rhi::DescriptorType::StorageImage,out},{8,rhi::DescriptorType::Sampler,nullptr,nullptr,0,0,sp}});
}
